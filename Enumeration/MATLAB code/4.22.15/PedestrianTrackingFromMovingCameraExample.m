...
option.ROI                  = [1,1,700,500];   % A rectangle [x, y, w, h] that limits the processing area to ground locations.
...
% Y-coordinate of the pedestrian's feet.
    ...
    function obj = setupSystemObjects(videoFile,scaleDataFile)
        ...
        obj.videoPlayer = vision.VideoPlayer('Position', [200, 200, 800, 550]);
        ...
        obj.peopleDetector = vision.PeopleDetector('UprightPeople_96x48',...
                                                    'MinSize',[100,50],'MaxSize',[500,200], ...
